...
use crate::queries::notification::SetTokenQuery as SetNotificationTokenQuery;
...
impl Client {
    fn new(root_uri: Uri, melior_uri: Uri, auth: Option<Auth>, quota: Quota) -> Self {
        ...
        // HTTP protocols have to be explicitly enabled
        #[cfg(feature = "http2")]
        let connector = builder.enable_all_versions().build();
    ...
    pub async fn logout(&self) -> Result<&Self> {
        ...
        LogoutQuery {}.send_request(self).await?;
    ...
    /// # Errors
    ///
    /// Returns [`jwt::Error`] if an error occurs while parsing the provided credentials.
    pub async fn set_auth(&self, auth: Option<Auth>) -> jwt::Result<&Self> {
    ...
    pub async fn set_push_token(&self, token: &str) -> Result<&Self> {
        SetNotificationTokenQuery::new(token)
            .send_request(self)
            .await?;
        Ok(self)
    }
        ...
        for<'a> &'a <R::Error as RequestError>::Source: From<&'a RootError>,
    {
        ...
        self.inner
            .root_service
            .send_request(&self.hyper_client, request, attachments, HeaderMap::new())
            .await
        ...
        for<'a> &'a <R::Error as RequestError>::Source: From<&'a MeliorError>,
    {
        ...
        self.inner
            .melior_service
            .send_query(&self.hyper_client, query, headers)
            .await
        ...
        for<'a> &'a <R::Error as RequestError>::Source: From<&'a MeliorError>,
    {
        ...
        self.inner
            .melior_service
            .send_query(&self.hyper_client, query, HeaderMap::new())
            .await
