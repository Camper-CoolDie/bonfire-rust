...
impl Serialize for RawKind {
        ...
        S: Serializer,
    {
        let kind = match self {
            ...
            RawKind::AccountActionRejected => 63,
            RawKind::AccountTargetActionRejected => 64,
...
impl<'de> Deserialize<'de> for RawKind {
        ...
        D: Deserializer<'de>,
    {
        Ok(match i64::deserialize(deserializer)? {
            ...
            63 => RawKind::AccountActionRejected,
            64 => RawKind::AccountTargetActionRejected,
...
impl From<RawKind> for Kind {
    fn from(value: RawKind) -> Self {
        match value {
            ...
            RawKind::FandomAccepted => Kind::FandomAccepted,
            ...
            RawKind::AccountBanned => Kind::AccountBanned,
            ...
            RawKind::AccountActionRejected => Kind::AccountActionRejected,
            RawKind::AccountTargetActionRejected => Kind::AccountTargetActionRejected,
