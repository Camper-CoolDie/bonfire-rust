...
use crate::models::notification::RubricOwnerAssigned;
use crate::requests::raw::{RawAccountRef, RawGender, RawLanguage};
use crate::{Error, Result};

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub(crate) struct RawOwnerAssigned {
...
impl TryFrom<RawOwnerAssigned> for RubricOwnerAssigned {
    type Error = Error;

    fn try_from(value: RawOwnerAssigned) -> Result<Self> {
        Ok(Self {
            id: value.id,
            name: value.name,
